...
set format y '%.2e'
plot \
'fib2.70.time' using 1:($2>0?$3/$2:$2) t 'fib2(n)' w linesp lw 2 ps 2, \
'fib3.70.time' using 1:($2>0?$3/$2:$2) t 'fib3(n)' w linesp lw 2 ps 2, \
'fib4.70.time' using 1:($2>0?$3/$2:$2) t 'fib4(n)' w linesp lw 2 ps 2, \
'fib5.70.time' using 1:($2>0?$3/$2:$2) t 'fib5(n)' w linesp lw 2 ps 2, \
'fib6.70.time' using 1:($2>0?$3/$2:$2) t 'fib6(n)' w linesp lw 2 ps 2, \
'fib7.70.time' using 1:($2>0?$3/$2:$2) t 'fib7(n)' w linesp lw 2 ps 2, \
