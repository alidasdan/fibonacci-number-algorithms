...
for ((a=2; a<=12; a+=1)); do
    ...
    for ((i=0; i<=30; i+=1)); do
        echo '1' $a $i;
        ad_fib.py -n $i -a $a -r 10000 >> results/fib$a.30;
    done;
done
...
for ((a=2; a<=12; a+=1)); do
    ...
    for ((i=0; i<=70; i+=1)); do
        echo '2' $a $i;
        ad_fib.py -n $i -a $a -r 10000 >> results/fib$a.70;
    done;
done
